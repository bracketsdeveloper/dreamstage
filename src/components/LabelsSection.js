...
const LabelsSection = () => {
  ...
  const labels = [
    ...
    { text: "Community-Driven Collaboration – Bridging the gap between artists and businesses through intuitive and efficient technology.Building a vibrant, interconnected network of artists, businesses, and cultural enthusiasts.", icon: "fa-handshake" },
